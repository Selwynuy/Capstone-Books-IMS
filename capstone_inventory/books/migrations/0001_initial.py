    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borrower_id', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('returner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='returns', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
